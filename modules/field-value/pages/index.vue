        ...
        <v-card>
            ...
            >
                ...
                <template #item.action="{ item }">
                    <div class="actions">
                        <v-btn icon width="22" height="22" :to="{ name: 'field-values.update', params: { id: item.id } }">
                            <pencil-alt-icon class="h-6 w-6" />
                        </v-btn>

<!--                        <v-btn icon width="22" height="22" class="mx-1" @click.prevent="deleteFieldValue(item)">-->
